module GeographyService
  ...
  def self.seed_areas
    ...
    ankara = Area.create!(name: 'Ankara', area_type: 'land', supply_center: true)
    belgium = Area.create!(name: 'Belgium', area_type: 'land', supply_center: true)
    berlin = Area.create!(name: 'Berlin', area_type: 'land', supply_center: true)
    brest = Area.create!(name: 'Brest', area_type: 'land', supply_center: true)
    budapest = Area.create!(name: 'Budapest', area_type: 'land', supply_center: true)
    bulgaria = Area.create!(name: 'Bulgaria', area_type: 'land', supply_center: true)
    constantinople = Area.create!(name: 'Constantinople', area_type: 'land', supply_center: true)
    denmark = Area.create!(name: 'Denmark', area_type: 'land', supply_center: true)
    edinburgh = Area.create!(name: 'Edinburgh', area_type: 'land', supply_center: true)
    ...
    kiel = Area.create!(name: 'Kiel', area_type: 'land', supply_center: true)
    liverpool = Area.create!(name: 'Liverpool', area_type: 'land', supply_center: true)
    london = Area.create!(name: 'London', area_type: 'land', supply_center: true)
    marseilles = Area.create!(name: 'Marseilles', area_type: 'land', supply_center: true)
    moscow = Area.create!(name: 'Moscow', area_type: 'land', supply_center: true)
    munich = Area.create!(name: 'Munich', area_type: 'land', supply_center: true)
    naples = Area.create!(name: 'Naples', area_type: 'land', supply_center: true)
    norway = Area.create!(name: 'Norway', area_type: 'land', supply_center: true)
    paris = Area.create!(name: 'Paris', area_type: 'land', supply_center: true)
    portugal = Area.create!(name: 'Portugal', area_type: 'land', supply_center: true)
    rome = Area.create!(name: 'Rome', area_type: 'land', supply_center: true)
    rumania = Area.create!(name: 'Rumania', area_type: 'land', supply_center: true)
    saint_petersburg = Area.create!(name: 'Saint Petersburg', area_type: 'land', supply_center: true)
    serbia = Area.create!(name: 'Serbia', area_type: 'land', supply_center: true)
    sevastopol = Area.create!(name: 'Sevastopol', area_type: 'land', supply_center: true)
    smyrna = Area.create!(name: 'Smyrna', area_type: 'land', supply_center: true)
    ...
    trieste = Area.create!(name: 'Trieste', area_type: 'land', supply_center: true)
    tunis = Area.create!(name: 'Tunis', area_type: 'land', supply_center: true)
    venice = Area.create!(name: 'Venice', area_type: 'land', supply_center: true)
    vienna = Area.create!(name: 'Vienna', area_type: 'land', supply_center: true)
    warsaw = Area.create!(name: 'Warsaw', area_type: 'land', supply_center: true)
